...
| [aws_guardduty_detector_feature.rds_login_events](https://registry.terraform.io/providers/hashicorp/aws/latest/docs/resources/guardduty_detector_feature) | resource |
...
| <a name="input_enable_rds_protection"></a> [enable_rds_protection](#input_enable_rds_protection) | Configure and enable RDS protection analyzing login activity for potential access threats. Defaults to `true`. | `bool` |
