...
| <a name="input_enable_rds_protection"></a> [enable_rds_protection](#input_enable_rds_protection) | Configure and enable RDS protection analyzing login activity for potential access threatsDefaults to `false`. | `bool` |
